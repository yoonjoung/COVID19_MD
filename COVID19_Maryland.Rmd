...
```
COVID-19 has affected __adult population relatively evenly across different ages__ (above 200 per 100,000 population in all age groups 30 and above). Recently, however, the incidence rate has increased more rapidly among those 80 and older. Currently, the incidence rate is highest, `r incidencetop` per 100,000 population, among people `r incidencetopage` years of age.  
...
subplot(fig1 , fig2, fig3, fig4, fig5, fig6, fig7, fig8, fig9, fig10,
        nrows = 3, shareX = TRUE )%>%
