...
```
COVID-19 has affected __adult population relatively evenly across different ages__. The incidence rate is highest, `r incidencetop` per 100000 population, among people between `r incidencetopage` years of age. But, the rates are above 90 in all age groups 30 and above. 
...
And, below detailed figure is for `r ncounty150` counties with 150 or more confirmed cases. __The number of daily new cases has increased steadily (and almost exponentially) in Baltimore county and Prince George's county__. A few other counties (e.g., Montgomery county) need to be monitored closely too. 
...
subplot(fig1 , fig2, fig3, fig4, fig5, fig6, fig7,
...
__Data sources__:  
1. All COVID-19 data for counties come from New York Times' [Coronavirus in the U.S.: Latest Map and Case Count](https://github.com/nytimes/covid-19-data). Accessed on April 7, 2020, 12:39PM EDT.   
2. All COVID-19 data for Maryland disaggregated by age and sex come from [Maryland COVID-19 Case Map Dashboard](https://coronavirus.maryland.gov/) by Maryland Department of Health. This dashboard presents latest numbers as of 10:00AM on each day. Accessed on April 7, 2020.      
